...
import org.salespointframework.quantity.QQuantity;
...
class InventoryController {
	...
	@PreAuthorize("hasRole('BOSS')")
	@PostMapping("/stock/refill/{item}")
	String fillStock(@PathVariable UniqueInventoryItem item) {
		item.increaseQuantity(Quantity.of(10));
		inventory.save(item);
